...
namespace HSTUTU_HFT_2021221.Data
{
    public class BlogDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Tag t1 = new Tag() { Name = "Tag Zwei", Id = 1, PostId = 1 };
            Tag t2 = new Tag() {  Name = "Tag Uno", Id = 2, PostId = 3 };           
            Tag t3 = new Tag() { Name = "Tag Police", Id = 3, PostId = 2};
            Tag t4 = new Tag() { Name = "Tag Women", Id = 4, PostId = 4 };
